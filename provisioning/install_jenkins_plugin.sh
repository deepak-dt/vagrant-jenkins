...
##########################################################################################################################################
# Usage:
# mkdir ./plugins && ./install_jenkins_plugin.sh -d ./plugins -a git@3.3.0 xunit@1.102
# 
# For installing latest version of plug-ins use following and update 
# plugin_repo_url to "https://updates.jenkins-ci.org/latest/"
# ./installPlugins -d /var/jenkins/plugins/ -a greenballs@latest
#
# Make sure to try jenkins rest api first
# curl -X POST --data "<jenkins><install plugin='${name}@latest' /></jenkins>" --header 'Content-Type: text/xml' \
...
#plugin_repo_url="https://updates.jenkins-ci.org/latest/"
